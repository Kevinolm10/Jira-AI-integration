...
class UserJiraProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'jira_username', 'jira_account_id', 'jira_server', 'is_active', 'last_login_jira')
    list_filter = ('is_active', 'jira_server', 'created_at')
    search_fields = ('user__username', 'user__email', 'jira_username', 'jira_account_id')
